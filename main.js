...
function myKeyDown(e) {
    ...
    if (Car1X > 680 && Car2X < 680) {
        console.log("White Car Wins");
        document.getElementById("Output").innerHTML = "<h2>Game Status: White Car Won</h2>";
    } else if (Car2X > 680 && Car1X < 680) {
        console.log("Yellow Car Wins");
        document.getElementById("Output").innerHTML = "<h2>Game Status: Yellow Car Won</h2>";
    } else if (Car2X > 680 && Car1X > 680) {
        console.log("Tie");
        document.getElementById("Output").innerHTML = "<h2>Game Status: It is a Tie </h2>";
    }
